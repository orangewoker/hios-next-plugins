...
| 小红书素材库 | 0.5.0 | `https://github.com/orangewoker/hios-next-plugins/tree/main/plugins/xiaohongshu-assets` |
| Pinterest 素材库 | 0.3.2 | `https://github.com/orangewoker/hios-next-plugins/tree/main/plugins/pinterest-assets` |
...
| K2 人像提示词生成器 | 0.1.3 | `https://github.com/orangewoker/hios-next-plugins/tree/main/plugins/k2-prompt-generator` |
